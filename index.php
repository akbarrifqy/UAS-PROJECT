<html>
	<head>
		<title>Pilkasis | SMK Pelita Ynh</title>
		<link rel="shortcut icon" href="gambar/pelita.png">
			...
			<div class="container">
				...
				<div class="navbar-header">
					<a href="." class="navbar-brand">
						<img class="logo" src="gambar/pelita.png"/>
						<h1>Pilkasis</h1>
						<h2>SMK PELITA YNH</h2>
					</a>
		...
		<div class="cover">
			<div class="cover-overlay">
				<div class="col-lg-7 col-sm-7 col-xs-12 box-title">
					<h1>Pilkasis<span class="color-title"> SMK Pro</span></h1>
					<h2>Pemilihan Ketua OSIS SMK Pelita Ynh (SMK PRO)</h2>
				</div>
			</div>
		</div>		
		<!-- End Cover -->
...
?>
			...
			<div class="col-md-12 primary text-center zero-panel">
				...
				<div class="col-md-4 col-sm-6 gallery">
					<a class="gallery-link" href="#">
						<div class="caption">
							<div class="caption-content danger">
								<span>Workshop Depicta 2020</span>
							</div>
						</div>
		...
		<div class="row content" id="osis">
			<div class="col-md-12 primary zero-panel text-center">
				<div class="col-md-12 zero-panel-content">
					<h1>PERSONIL OSIS</h1>
					<p>Inilah personil OSIS periode 2020-2023</p>
			...
			<div class="col-lg-12 danger text-center zero-panel">
				...
				<ul class="list-inline" id="chart-skill">
					<li><a href="siswa/" target="_blank">
						<div class="easy-pie-chart percentage" data-percent="100" data-color="#00FFFF">
		...
		<div class="row content" id="contact">
			<div class="col-md-12 danger text-center zero-panel">
				<div class="col-md-12 zero-panel-content">
					<h1> HUBUNGI KAMI </h1>
					<p>Jl. Otto Iskandardinata Gang Pelita Sukabumi No.RT. 01, RW.2, Nanggeleng, Kec. Citamiang, Kota Sukabumi, Jawa Barat 43145</p>
					...
					<div class="col-md-6 text-left">
						...
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.69364902089!2d106.93362681477299!3d-6.927174494994978!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68482545a52107%3A0xf59948d1c72caa88!2sSMK%20Pelita%20YNH%20Kota%20Sukabumi!5e0!3m2!1sid!2sid!4v1637544268963!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
						</div>
					</div>
					<div class="clear"></div>
				</div>
		...
		<footer class="primary text-center">
			<div class="row">
				...
				<div class="col-md-4">
					<h3>LOKASI</h3>
					<p>
					Jl. Otto Iskandardinata Gang Pelita Sukabumi No.RT. 01, RW.2, Nanggeleng, Kec. Citamiang, Kota Sukabumi, Jawa Barat 43145
					</p>
				</div>
			</div>
		</footer>
		...
		<script>
			var img = ['gambar/depicta2016.jpg', 'gambar/rohis.jpg'];
